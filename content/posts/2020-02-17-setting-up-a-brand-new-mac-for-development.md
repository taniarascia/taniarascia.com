...
You used to have to install [Homebrew Cask](https://sourabhbajaj.com/mac-setup/Homebrew/Cask.html) to download GUI applications, but now it Cask comes installed with Homebrew right out of the box.
