export const shelvesList = [
  ...
  },
  {
    ...
    description:
      'As my work became more advanced, I became more interested in documenting the process, including topics like authorization and authentication, data-driven design, build tools, and architecture.',
    links: [
      {
      ...
      {
        title: 'This, Bind, Call, and Apply',
