        ...
        <div className="container">
          <section>
            ...
            <p>
              <small>
                <i>
                  2020 &mdash; TypeScript, React/Redux, Node/Express, GitHub
                  OAuth
                </i>
              </small>
            </p>
            ...
            <p>
              I built this app because I wanted a simpler, IDE-like,
              WYSIWYG-free note-taking program that would be accessible from any
              platform via the web. I also wanted it to sync without creating
              users or requiring a database.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Chip8.js includes a CPU class that handles all the internal logic
              of the emulator, and individual classes written for interfacing
              with a web, command line, or native client. The emulator plays
              CHIP-8 ROMs for simple games like Pong, Tron, and Tetris.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              I made my first websites in the late '90s, when HTML was written
              in uppercase, tables were using for creating layouts, and CSS
              didn't exist yet. When CSS came around I learned the most basic of
              float based layouts, but then I went off and worked another career
              for a decade.
            </p>
            <p>
              ...
              to implement it. I wasn't happy using something I didn't
              understand, and I thought those frameworks were too bloated, so I
              created my own with Sass that I used for several design projects.
              Primitive was created to provide helpful, browser-consistent
              styling for default HTML elements, such as buttons, forms, tables,
